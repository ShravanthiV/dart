...
class _L extends StatelessWidget {
 void s(BuildContext c, String m) => ScaffoldMessenger.of(c).showSnackBar(SnackBar(content: 
Text(m)));
 @override
 ...
 TextButton(onPressed: () => s(c, "Password reset link sent!"), child: Text("Forgot 
Password?")),
